export default class BezierQuad{
    static at( a: TVec3, b: TVec3, c: TVec3, t: number, out: TVec3 = [0,0,0] ) : TVec3{
	...
	static dxdy( a: TVec3, b: TVec3, c: TVec3, t: number, out: TVec3 = [0,0,0] ) : TVec3{
		// 2 * (1-t) * (b-a) + 2 * t * ( c - b );
		const s2 = 2 * ( 1-t );
		const t2 = 2 * t;
	...
	static dxdy2( a: TVec3, b: TVec3, c: TVec3, t: number, out: TVec3 = [0,0,0] ) : TVec3{
        // 2 * ( c - 2 * b + a )
