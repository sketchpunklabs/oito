export default class Mat4 extends Array< number >{
    ...
    copyTo( out: TMat4 ): this{
        for( let i=0; i < 16; i++ ) out[ i ] = this[ i ];
        return this;
    }
    ...
    getScale( out: TVec3 = [0,0,0] ): TVec3{
        const m11 = this[0],
              m12 = this[1],
              m13 = this[2],
              m21 = this[4],
    ...
    getRotation( out: TVec4 = [0,0,0,1] ): TVec4{
    ...
    */
    ...
    fromQuatTran( q: ConstVec4, v: ConstVec3 ): this{
        // Quaternion math
        const x  = q[0], y = q[1], z = q[2], w = q[3],
              x2 = x + x,
              y2 = y + y,
    ...
    fromQuatTranScaleOrigin( q: ConstVec4, v: ConstVec3, s: ConstVec3, o: ConstVec3 ): this {
        // Quaternion math
        const x  = q[0],
              y  = q[1],
              z  = q[2],
