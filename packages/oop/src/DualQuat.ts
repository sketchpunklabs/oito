export default class DualQuat extends Array< number >{
    // #region CONSTRUCTORS 
    constructor()
    constructor( q: ConstVec4 )
    constructor( q: ConstVec4,  t: ConstVec3 )
    constructor( q?: ConstVec4, t?: ConstVec3 ){
        super( 8 );
    ...
    /** REAL Part of DQ */
    getQuat( out: TVec4 = [0,0,0,0] ): TVec4{
        out[ 0 ] = this[ 0 ];
        out[ 1 ] = this[ 1 ];
        out[ 2 ] = this[ 2 ];
        out[ 3 ] = this[ 3 ];
    ...
    fromQuatTran( q: ConstVec4, t: ConstVec3 ): this{
        const ax = t[0] * 0.5;
        const ay = t[1] * 0.5;
        const az = t[2] * 0.5;
        const bx = q[0]; 
    ...
    fromTranslation( t: ConstVec3 ): this{
        this[0] = 0;
        this[1] = 0;
        this[2] = 0;
        this[3] = 1;
    ...
    fromMul( a: ConstVec8, b: ConstVec8 ): this{
    ...
    fromConjugate( a: ConstVec8 ): this{
        this[0] = -a[0];
        this[1] = -a[1];
        this[2] = -a[2];
        this[3] =  a[3];
