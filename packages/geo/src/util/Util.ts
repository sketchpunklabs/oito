// import { Maths, Vec3, TVec3 } from '@oito/oop';
...
class Util{
    ...
    /** Compute the Indices for each edge of a grid generated by this util */
    static gridEdgeIndices( row_size: number, row_cnt: number ): Array< Array<number> >{
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // TOP - Left > Right
        const et: Array<number> = [];
        for( i=0; i < row_size; i++ ) et.push( i );
        
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // Right - Top > Bottom
        // Last Point of each row
        const er: Array<number> = [];
        for( i=0; i < row_cnt; i++ ) er.push( i * row_size + xCell );

        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // Bottom - Right > Left
        // Starting at the LAST Index, work backwards
        const eb: Array<number> = [];
        for( i=0; i < row_size; i++ ) eb.push( len - i - 1 );

       //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // LEFT - Bottom > Top
        // Compute the first index for each row, but start from the last row toward the first
        const el: Array<number> = [];
        for( i=yCell; i >=0; i-- ) el.push( i * row_size );
    ...
    */
    ...
    static shiftVertices( verts: Array<number>, offset:TVec3, iStart=0, iEnd=0 ): void{
